...
from elektro.traits import BiophysicsInputTrait, IsVectorizableTrait, BiophysicsTrait, CompartmentTrait, ExperimentTrait, ModelConfigInputTrait, HasPresignedDownloadAccessor, CompartmentInputTrait, HasParquetStoreAccesor, SimulationTrait, SectionInputTrait, ModelConfigTrait, HasZarrStoreAccessor, TopologyTrait, HasZarrStoreTrait, HasDownloadAccessor, TopologyInputTrait
from rath.scalars import ID, IDCoercible
from kanne.scalars import SpecificCapacitance, Length, ElectricalConductance, Temperature, ElectricPotential, Duration, Frequency, Resistivity
from elektro.scalars import FileLikeCoercible, FileLike, BigFileLike, BigFileLikeCoercible, ArrayLike, TraceLike, TraceCoercible, TwoDVector, FiveDVector, ArrayLikeCoercible, RGBAColor
from typing import Union, AsyncIterator, Annotated, Iterable, Literal, Any, Iterator, List, Dict, Optional
...
class CompartmentInput(CompartmentInputTrait, BaseModel):
    ...
    global_params: Annotated[Optional[List['GlobalParamMapInput']], GraphQLDefault('[]')] = Field(alias='globalParams', default=None, description='The non-mechanistic (global) parameters applied to this compartment.')
...
class DistributionInput(BaseModel):
    ...
    proximal_value: Optional[float] = Field(alias='proximalValue', default=None, description="The value at path distance 0 (required for 'linear').")
    distal_value: Optional[float] = Field(alias='distalValue', default=None, description="The value at the most distal segment (required for 'linear').")
...
class SectionInput(SectionInputTrait, BaseModel):
    ...
    ra: Annotated[Optional[Resistivity], GraphQLDefault('35.4 cm * Ω')] = Field(default=None, description='Axial resistivity (NEURON Ra).')
    'Axial resistivity (NEURON Ra).\nDefault: 35.4 cm * Ω'
    cm: Annotated[Optional[SpecificCapacitance], GraphQLDefault('1 µF / cm ** 2')] = Field(default=None, description='Specific membrane capacitance (NEURON cm).')
...
class SectionParamMapDistribution(BaseModel):
    ...
    proximal_value: Optional[float] = Field(default=None, alias='proximalValue')
    "The value at path distance 0 (required for 'linear')."
    distal_value: Optional[float] = Field(default=None, alias='distalValue')
...
def compartment_input(id: str, mechanisms: Iterable[str], section_params: Union[Optional[Iterable[SectionParamMapInput]], UnsetType]=UNSET, global_params: Union[Optional[Iterable[GlobalParamMapInput]], UnsetType]=UNSET, color: Union[Optional[RGBAColor], UnsetType]=UNSET) -> CompartmentInput:
...
def distribution_input(kind: DistributionKind, value: Union[Optional[float], UnsetType]=UNSET, proximal_value: Union[Optional[float], UnsetType]=UNSET, distal_value: Union[Optional[float], UnsetType]=UNSET, expression: Union[Optional[str], UnsetType]=UNSET) -> DistributionInput:
    """Creates a DistributionInput

Arguments:
    kind: The kind of spatial distribution.
    value: The uniform value applied to every segment (required for 'uniform').
    proximal_value: The value at path distance 0 (required for 'linear').
    distal_value: The value at the most distal segment (required for 'linear').
...
def section_input(id: str, nseg: int, diam: Length, ra: Resistivity, cm: SpecificCapacitance, category: Union[Optional[str], UnsetType]=UNSET, length: Union[Optional[Length], UnsetType]=UNSET, coords: Union[Optional[Iterable[CoordInput]], UnsetType]=UNSET, parent: Union[Optional[ConnectionInput], UnsetType]=UNSET) -> SectionInput:
...
Arguments:
    ...
    ra: Axial resistivity (NEURON Ra).
    cm: Specific membrane capacitance (NEURON cm).
