...
from elektro.funcs import subscribe, asubscribe, execute, aexecute
from kanne.scalars import Frequency, Length, Dimension, ElectricPotential, Temperature, SpecificCapacitance, Resistivity, Concentration, ElectricalConductance, Unit, Duration, GenericQuantity
from elektro.traits import ModelConfigInputTrait, SimulationTrait, TopologyInputTrait, ModelConfigTrait, IsVectorizableTrait, HasParquetStoreAccesor, HasPresignedDownloadAccessor, TopologyTrait, CompartmentInputTrait, HasZarrStoreAccessor, HasZarrStoreTrait, SectionInputTrait, HasDownloadAccessor, ExperimentTrait, BiophysicsTrait, CompartmentTrait, BiophysicsInputTrait
from elektro.scalars import ArrayLikeCoercible, RGBAColor, TwoDVector, TraceLike, FileLike, ArrayLike, BigFileLike, FiveDVector, TraceCoercible, FileLikeCoercible, BigFileLikeCoercible
from typing import Any, List, Literal, Dict, Union, Iterator, Annotated, Optional, Iterable, AsyncIterator
...
class CompartmentInput(CompartmentInputTrait, BaseModel):
    ...
    section_params: Annotated[Optional[List['SectionParamMapInput']], GraphQLDefault('[]')] = Field(alias='sectionParams', default=None, description='The mechanism-specific parameters applied to the sections of this compartment.')
    'The mechanism-specific parameters applied to the sections of this compartment.\nDefault: []'
    ions: Annotated[Optional[List['IonInput']], GraphQLDefault('[]')] = Field(default=None, description='Ion species settings (reversal potentials and concentrations) applied to this compartment.')
    'Ion species settings (reversal potentials and concentrations) applied to this compartment.\nDefault: []'
    color: Optional[RGBAColor] = Field(default=None, description='An optional RGBA color (list of 4 values) used to render this compartment in the UI.')
    model_config = ConfigDict(extra='forbid', validate_assignment=True, populate_by_name=True, use_enum_values=True)
...
class ConnectionInput(BaseModel):
    ...
    parent_location: Annotated[Optional[float], GraphQLDefault('1.0')] = Field(alias='parentLocation', default=None, description='The position along the parent section where this section attaches, between 0 and 1.')
    'The position along the parent section where this section attaches, between 0 and 1.\nDefault: 1.0'
    child_end: Annotated[Optional[float], GraphQLDefault('0.0')] = Field(alias='childEnd', default=None, description='Which end of this section attaches to the parent: 0 (default) or 1.')
...
class CoordInput(BaseModel):
    ...
    diam: Optional[Length] = Field(default=None, description='The diameter of the section at this point (NEURON pt3d). Falls back to the section diameter when omitted.')
    model_config = ConfigDict(extra='forbid', validate_assignment=True, populate_by_name=True, use_enum_values=True)
...
class DistributionInput(BaseModel):
    ...
    kind: Annotated[Optional[DistributionKind], GraphQLDefault('UNIFORM')] = Field(default=None, description='The kind of spatial distribution.')
    'The kind of spatial distribution.\nDefault: UNIFORM'
    value: Optional[GenericQuantity] = Field(default=None, description="The uniform value applied to every segment (required for 'uniform'). A unit-bearing quantity, e.g. '0.12 S/cm2'.")
    proximal_value: Optional[GenericQuantity] = Field(alias='proximalValue', default=None, description="The value at path distance 0 (required for 'linear'). A unit-bearing quantity.")
    distal_value: Optional[GenericQuantity] = Field(alias='distalValue', default=None, description="The value at the most distal segment (required for 'linear'). A unit-bearing quantity.")
...
class IonInput(BaseModel):
    ...
    style: Annotated[Optional[IonStyle], GraphQLDefault('FIXED_REVERSAL')] = Field(default=None, description='How the reversal potential and concentrations are treated (NEURON ion_style): a fixed reversal parameter, computed from fixed concentrations via Nernst, or with concentrations as states advanced by an accumulation mechanism.')
    ...
    reversal_potential: Optional[ElectricPotential] = Field(alias='reversalPotential', default=None, description="The reversal potential for this ion (NEURON e<ion>, e.g. ena). Unset leaves NEURON's default.")
    internal_concentration: Optional[Concentration] = Field(alias='internalConcentration', default=None, description='The intracellular concentration for this ion (NEURON <ion>i, e.g. nai).')
    external_concentration: Optional[Concentration] = Field(alias='externalConcentration', default=None, description='The extracellular concentration for this ion (NEURON <ion>o, e.g. nao).')
    model_config = ConfigDict(extra='forbid', validate_assignment=True, populate_by_name=True, use_enum_values=True)
...
class ModelConfigInput(ModelConfigInputTrait, BaseModel):
    ...
    ions: Annotated[Optional[List[IonInput]], GraphQLDefault('[]')] = Field(default=None, description="Model-wide default ion settings (reversal potentials / concentrations). A compartment's own ions override these by ion name.")
    "Model-wide default ion settings (reversal potentials / concentrations). A compartment's own ions override these by ion name.\nDefault: []"
    mechanism_globals: Annotated[Optional[List[MechanismGlobalParamInput]], GraphQLDefault('[]')] = Field(alias='mechanismGlobals', default=None, description='GLOBAL mechanism parameters (NEURON GLOBAL variables, e.g. q10_hh), shared across every instance of the mechanism.')
    'GLOBAL mechanism parameters (NEURON GLOBAL variables, e.g. q10_hh), shared across every instance of the mechanism.\nDefault: []'
    ra: Optional[Resistivity] = Field(default=None, description="Model-wide default axial resistivity (NEURON Ra). A section's own ra overrides this; unset falls back to NEURON's built-in 35.4 Ω·cm.")
    cm: Optional[SpecificCapacitance] = Field(default=None, description="Model-wide default specific membrane capacitance (NEURON cm). A section's own cm overrides this; unset falls back to NEURON's built-in 1 µF/cm².")
...
class ParameterInput(BaseModel):
    ...
    'Default: False'
    reference_unit: Optional[Unit] = Field(alias='referenceUnit', default=None)
    proposed_units: Optional[List[Unit]] = Field(alias='proposedUnits', default=None)
...
class SectionInput(SectionInputTrait, BaseModel):
    ...
    nseg: Annotated[Optional[int], GraphQLDefault('1')] = Field(default=None, description='The number of segments the section is discretized into (used when d_lambda is not set). NEURON convention prefers an odd count so the section has a true midpoint node.')
    ...
    d_lambda: Optional[float] = Field(alias='dLambda', default=None, description="If set, nseg is computed from NEURON's d_lambda rule (target fraction of the AC length constant at 100 Hz per segment; 0.1 is typical) and overrides the fixed nseg.")
    diam: Annotated[Optional[Length], GraphQLDefault('1 µm')] = Field(default=None, description='The diameter of the section (stylized geometry). Overridden by per-point coord diameters when coords are supplied.')
    'The diameter of the section (stylized geometry). Overridden by per-point coord diameters when coords are supplied.\nDefault: 1 µm'
    length: Optional[Length] = Field(default=None, description='Length of the section (stylized geometry). Required if coords is not provided; ignored when coords are supplied.')
    ra: Optional[Resistivity] = Field(default=None, description="Axial resistivity (NEURON Ra). Unset inherits the model-wide default, then NEURON's built-in 35.4 Ω·cm.")
    cm: Optional[SpecificCapacitance] = Field(default=None, description="Specific membrane capacitance (NEURON cm). Unset inherits the model-wide default, then NEURON's built-in 1 µF/cm².")
    coords: Optional[List[CoordInput]] = Field(default=None, description="The 3D coordinates (NEURON pt3d) describing the section's geometry. Required if length is not provided; when supplied they take precedence over length/diam. At least two points are needed to define a cable.")
    parent: Optional[ConnectionInput] = Field(default=None, description="The connection to this section's parent section. None for the root section of the cell.")
    model_config = ConfigDict(extra='forbid', validate_assignment=True, populate_by_name=True, use_enum_values=True)
...
class Section(BaseModel):
    ...
    nseg: int
    'The number of segments the section is discretized into (used when d_lambda is not set). NEURON convention prefers an odd count so the section has a true midpoint node.'
    d_lambda: Optional[float] = Field(default=None, alias='dLambda')
...
class SectionParamMapDistribution(BaseModel):
    ...
    'The kind of spatial distribution.'
    value: Optional[GenericQuantity] = Field(default=None)
    "The uniform value applied to every segment (required for 'uniform'). A unit-bearing quantity, e.g. '0.12 S/cm2'."
    proximal_value: Optional[GenericQuantity] = Field(default=None, alias='proximalValue')
    "The value at path distance 0 (required for 'linear'). A unit-bearing quantity."
    distal_value: Optional[GenericQuantity] = Field(default=None, alias='distalValue')
...
class Ion(BaseModel):
    ...
    style: IonStyle
    'How the reversal potential and concentrations are treated (NEURON ion_style): a fixed reversal parameter, computed from fixed concentrations via Nernst, or with concentrations as states advanced by an accumulation mechanism.'
    reversal_potential: Optional[ElectricPotential] = Field(default=None, alias='reversalPotential')
    "The reversal potential for this ion (NEURON e<ion>, e.g. ena). Unset leaves NEURON's default."
    internal_concentration: Optional[Concentration] = Field(default=None, alias='internalConcentration')
    'The intracellular concentration for this ion (NEURON <ion>i, e.g. nai).'
    external_concentration: Optional[Concentration] = Field(default=None, alias='externalConcentration')
...
def compartment_input(id: str, mechanisms: Iterable[str], section_params: Union[Optional[Iterable[SectionParamMapInput]], UnsetType]=UNSET, ions: Union[Optional[Iterable[IonInput]], UnsetType]=UNSET, color: Union[Optional[RGBAColor], UnsetType]=UNSET) -> CompartmentInput:
...
def coord_input(x: Length, y: Length, z: Length, diam: Union[Optional[Length], UnsetType]=UNSET) -> CoordInput:
...
def distribution_input(kind: DistributionKind, value: Union[Optional[GenericQuantity], UnsetType]=UNSET, proximal_value: Union[Optional[GenericQuantity], UnsetType]=UNSET, distal_value: Union[Optional[GenericQuantity], UnsetType]=UNSET, expression: Union[Optional[str], UnsetType]=UNSET) -> DistributionInput:
...
def ion_input(ion: str, style: IonStyle, reversal_potential: Union[Optional[ElectricPotential], UnsetType]=UNSET, internal_concentration: Union[Optional[Concentration], UnsetType]=UNSET, external_concentration: Union[Optional[Concentration], UnsetType]=UNSET) -> IonInput:
    """Creates a IonInput
...
def mechanism_global_param_input(mechanism: str, param: str, value: GenericQuantity, description: Union[Optional[str], UnsetType]=UNSET) -> MechanismGlobalParamInput:
...
def parameter_input(key: str, kind: ParameterKind, nullable: bool, label: Union[Optional[str], UnsetType]=UNSET, description: Union[Optional[str], UnsetType]=UNSET, default: Union[Optional[Any], UnsetType]=UNSET, reference_unit: Union[Optional[Unit], UnsetType]=UNSET, proposed_units: Union[Optional[Iterable[Unit]], UnsetType]=UNSET, dimension: Union[Optional[Dimension], UnsetType]=UNSET) -> ParameterInput:
...
def section_input(id: str, nseg: int, diam: Length, category: Union[Optional[str], UnsetType]=UNSET, d_lambda: Union[Optional[float], UnsetType]=UNSET, length: Union[Optional[Length], UnsetType]=UNSET, ra: Union[Optional[Resistivity], UnsetType]=UNSET, cm: Union[Optional[SpecificCapacitance], UnsetType]=UNSET, coords: Union[Optional[Iterable[CoordInput]], UnsetType]=UNSET, parent: Union[Optional[ConnectionInput], UnsetType]=UNSET) -> SectionInput:
...
def section_param_map_input(param: str, mechanism: str, distribution: DistributionInput, description: Union[Optional[str], UnsetType]=UNSET) -> SectionParamMapInput:
...
async def asearch_datasets(values: List[ID], search: Union[Optional[str], UnsetType]=UNSET, offset: Union[Optional[int], UnsetType]=UNSET, limit: Union[Optional[int], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchDatasetsQueryOptions]:
    """SearchDatasets 
...
def search_datasets(values: List[ID], search: Union[Optional[str], UnsetType]=UNSET, offset: Union[Optional[int], UnsetType]=UNSET, limit: Union[Optional[int], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchDatasetsQueryOptions]:
    """SearchDatasets 
...
async def asearch_files(search: Union[Optional[str], UnsetType]=UNSET, values: Union[Optional[List[ID]], UnsetType]=UNSET, offset: Union[Optional[int], UnsetType]=UNSET, limit: Union[Optional[int], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchFilesQueryOptions]:
    """SearchFiles 
...
def search_files(search: Union[Optional[str], UnsetType]=UNSET, values: Union[Optional[List[ID]], UnsetType]=UNSET, offset: Union[Optional[int], UnsetType]=UNSET, limit: Union[Optional[int], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchFilesQueryOptions]:
    """SearchFiles 
