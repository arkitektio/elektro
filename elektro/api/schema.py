...
from elektro.funcs import asubscribe, execute, aexecute, subscribe
...
class AnalogSignalChannelInput(BaseModel):
    ...
    model_config = ConfigDict(
        extra="forbid", validate_assignment=True, populate_by_name=True, use_enum_values=True
    )
...
class BlockSegmentInput(BaseModel):
    ...
    name: Optional[str] = None
    description: Optional[str] = None
    analog_signals: Annotated[Optional[List[AnalogSignalInput]], GraphQLDefault("[]")] = Field(
    ...
    "Default: []"
    spike_trains: Annotated[Optional[List["SpikeTrainInput"]], GraphQLDefault("[]")] = Field(
...
class ModelConfigInput(ModelConfigInputTrait, BaseModel):
    ...
    net_stimulators: Annotated[Optional[List["NetStimulatorInput"]], GraphQLDefault("[]")] = Field(
        alias="netStimulators",
        default=None,
        description="The list of net stimulators in the model.",
    )
    "The list of net stimulators in the model.\nDefault: []"
    net_connections: Annotated[Optional[List["NetConnectionInput"]], GraphQLDefault("[]")] = Field(
        alias="netConnections",
        default=None,
        description="The list of net connections in the model.",
    )
    "The list of net connections in the model.\nDefault: []"
    net_synapses: Annotated[Optional[List["NetSynapseInput"]], GraphQLDefault("[]")] = Field(
        alias="netSynapses", default=None, description="The list of net synapses in the model."
    )
...
class SectionInput(SectionInputTrait, BaseModel):
    ...
    nseg: Annotated[Optional[int], GraphQLDefault("1")] = Field(
        default=None, description="The number of segments the section is discretized into."
    )
    ...
    length: Optional[Length] = Field(
        default=None, description="Length of the section. Required if coords is not provided."
    )
    ...
    connections: Annotated[Optional[List[ConnectionInput]], GraphQLDefault("[]")] = Field(
        default=None, description="The connections of this section to its parent section(s)."
    )
...
def create_model_collection_input(
    name: str, models: Iterable[IDCoercible], description: Union[Optional[str], UnsetType] = UNSET
...
def section_param_map_input(
    param: str, mechanism: str, value: float, description: Union[Optional[str], UnsetType] = UNSET
