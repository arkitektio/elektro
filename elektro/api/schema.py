...
from typing import Optional, Any, Union, Iterable, List, Iterator, Literal, AsyncIterator, Annotated, Dict
from enum import Enum
from datetime import datetime
from elektro.scalars import FileLike, FiveDVector, BigFileLike, TwoDVector, FileLikeCoercible, TraceCoercible, ArrayLikeCoercible, TraceLike, ArrayLike, BigFileLikeCoercible
from elektro.traits import HasZarrStoreAccessor, TopologyInputTrait, CompartmentTrait, TopologyTrait, ModelConfigTrait, IsVectorizableTrait, HasDownloadAccessor, ModelConfigInputTrait, HasZarrStoreTrait, ExperimentTrait, BiophysicsInputTrait, HasPresignedDownloadAccessor, SimulationTrait, BiophysicsTrait, HasParquetStoreAccesor, SectionInputTrait, CompartmentInputTrait
from kanne.scalars import ElectricPotential, Frequency, Temperature, ElectricalConductance, Duration, Length
...
async def asearch_datasets(values: List[ID], search: Union[Optional[str], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchDatasetsQueryOptions]:
    """SearchDatasets 
...
def search_datasets(values: List[ID], search: Union[Optional[str], UnsetType]=UNSET, rath: Optional[ElektroRath]=None) -> List[SearchDatasetsQueryOptions]:
    """SearchDatasets 
