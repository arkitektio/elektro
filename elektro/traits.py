...
import dataclasses
from elektro.vars import current_ontology, current_graph
...
class IntermediateInstanceRelation:
    ...
    def __or__(self, other):
        from elektro.api.schema import create_entity_relation
...
class LinkedExpressionTrait(BaseModel):
    def create_entity(self) -> "Entity":
        from elektro.api.schema import create_entity
...
class EntityTrait(BaseModel):
    ...
    def set(self, metric: "LinkedExpressionTrait", value: float, **kwargs):
        from elektro.api.schema import create_entity_metric, ExpressionKind
...
class EntityRelationTrait(BaseModel):
    ...
    def set(self, metric: "LinkedExpressionTrait", value: float):
        from elektro.api.schema import create_relation_metric, ExpressionKind
