...
Middleware Support:
    ...
    Middleware is configured on the ElektroRath instance via its
    `middlewares` field.
...
from elektro.rath import ElektroRath, current_elektro_rath
from koil import unkoil_gen
from rath.turms.funcs import TOperation
from .errors import NoElektroFound
...
def execute(
    ...
    if not rath:
        raise NoElektroFound("No rath client found in context. Please provide a rath client.")
